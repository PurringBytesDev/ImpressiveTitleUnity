...
public class TerrainToolboxEditor : EditorWindow 
{
	...
	{	
		...
		if(terrainSubMode == TerrainEditorSubMode.Spline)
		{
			...
			Handles.SphereHandleCap(0, newPosition, Quaternion.identity, 5.0f, EventType.Repaint);
		...
		if(showField)
		{
			...
			Handles.SphereHandleCap(0, fieldStart, Quaternion.identity, 10.0f, EventType.Repaint);
			Handles.color = Color.red;
			Handles.SphereHandleCap(0, fieldEnd, Quaternion.identity, 10.0f, EventType.Repaint);
		}
