...
namespace Mirror
{
    ...
    public class NetworkRoomPlayer : NetworkBehaviour
    {
        ...
        // car index attempt to choose a special car
        [ReadOnly, Tooltip("Diagnostic index of the car, e.g. Kart1, Kart2, etc.")]
        [SyncVar(hook = nameof(CarIndexChanged))]
        public int carIndex;
        ...
        [Command]
        public void CmdChangeCarIndex(int index)
        {
            carIndex = index;
            NetworkRoomManager room = NetworkManager.singleton as NetworkRoomManager;
            // update room visual ????
        ...
        // about the same but used for car prefabs
        public virtual void CarIndexChanged(int oldIndex, int newIndex) { }
